...
win_nic_list      = {
    ...
    eitaastest-custom-image-win-gen2-nic-tx = {
      location    = "usgovtexas",
      subnet_name = "eitaastest-subnet-tx"
    },
    eitaastest-custom-image-win-gen2-nic-va = {
      location     = "usgovvirginia",
      subnet_name  = "eitaastest-subnet-va"
    }
...
linux_nic_list      = {
    ...
    eitaastest-custom-image-ubun-gen2-nic-tx = {
      location    = "usgovtexas",
      subnet_name = "eitaastest-subnet-tx"
    },
    eitaastest-custom-image-ubun-gen2-nic-va = {
      location     = "usgovvirginia",
      subnet_name  = "eitaastest-subnet-va"
    }
  }
...
custom_image_windows_vm_list      = {
    ...
    custimgwinvm2tx = {
      location          = "usgovtexas",
      nic               = "eitaastest-custom-image-win-gen2-nic-tx",
      image_gallery_rg  = "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY",
      vm_gen            = "2",
      os_name           = "windows-2022-gen2"
    },
    custimgwinvm2va = {
      location          = "usgovvirginia",
      nic               = "eitaastest-custom-image-win-gen2-nic-va",
      image_gallery_rg  = "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY",
      vm_gen            = "2",
      os_name           = "windows-2022-gen2"
    }
...
custom_image_ubuntu_vm_list      = {
    ...
    custimgubuvm2tx = {
      location          = "usgovtexas",
      nic               = "eitaastest-custom-image-ubun-gen2-nic-tx",
      image_gallery_rg  = "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY",
      vm_gen            = "2",
      os_name           = "ubuntu-2004-gen2"
    },
    custimgubuvm2va = {
      location          = "usgovvirginia",
      nic               = "eitaastest-custom-image-ubun-gen2-nic-va",
      image_gallery_rg  = "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY",
      vm_gen            = "2",
      os_name           = "ubuntu-2004-gen2"
    }
...
shared_image_definition = {
  windows-2022-gen2 = {                            
    gallery_name=                      "D_VA_EITAAS_INFRA_SHAREDIMAGEGALLERY",
    resource_group_name=               "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY"
  },
  ubuntu-2004-gen2 = {                            
    gallery_name=                      "D_VA_EITAAS_INFRA_SHAREDIMAGEGALLERY",
    resource_group_name=               "D-VA-EITAAS-INFRA-SHAREDIMAGEGALLERY"
